          ...
          <div className="space-y-4 animate-fade-in">
            ...
            <div className="space-y-3">
              <h1 className="font-basic-sans text-3xl sm:text-4xl lg:text-5xl font-black text-night leading-tight">
                Découvrez comment The Bradery a <span className="bg-gradient-to-r from-mint to-periwinkle bg-clip-text text-transparent font-black">multiplié ses avis</span> par 30
              </h1>
